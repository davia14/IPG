SELECT * FROM ip-ipg-data.ipg_transformations.surveysystemlvlpivoted PIVOT(sum(num_of_responses) AS num_of_responses, AVG(pct_sa_a) AS pct_sa_a, AVG(pct_sa_only) AS pct_sa_only, AVG(pct_agree_only) AS pct_agree_only
FOR question IN 
