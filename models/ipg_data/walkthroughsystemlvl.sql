...
AVG(CA_1_PPI) AS CA_1_PPI, AVG(CA_2_PPI) AS CA_2_PPI, AVG(CA_3_PPI) AS CA_3_PPI, AVG(total_PPI) AS total_PPI FROM ip-ipg-data.ipg_transformations.walkthroughschoollvlb
GROUP BY 1,2,3,4,5)
