...
AVG(ca_1_ppi) AS CA_1_PPI, AVG(ca2ppi) AS CA_2_PPI, AVG(ca3ppi) AS CA_3_PPI, AVG(totalppi) AS total_PPI FROM ip-ipg-data.ipg_transformations.walkthroughlvl GROUP BY 1,2,3,4,5,6), 
