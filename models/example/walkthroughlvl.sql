...
finalwithschool AS (select f.*, school.name AS school_year_engagement, school.school_year_c AS school_year
FROM finaltable AS f JOIN ip-ipg-data.salesforce.school_year_engagement_c AS school ON f.school_year_engagement_c = school.id), 
